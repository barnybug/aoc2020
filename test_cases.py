...
def test_day20_reorient():
    t = day20.Tile.parse('''Tile 2971:
..#.#....#
#...###...
#.#.###...
##.##..#..
...
..#.#.###.
...#.#.#.#''')
    assert np.array_equal(t.edges, [456, 532, 689, 85])
...
def test_day23_part1():
    assert day23.part1('389125467') == '67384529'
